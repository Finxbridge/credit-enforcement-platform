package com.finx.allocationreallocationservice.exception;
...
public class GlobalExceptionHandler {
        ...
        public ResponseEntity<CommonResponse<Void>> handleMultipartException(
                ...
                log.error("Multipart error on {}: {}", request.getDescription(false), ex.getMessage());
