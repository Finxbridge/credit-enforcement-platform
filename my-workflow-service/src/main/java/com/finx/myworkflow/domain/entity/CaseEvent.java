...
/**
 * Entity for case_events table - tracks all events related to a case
 * for end-to-end visibility in the workflow module.
 */
@Entity
...
public class CaseEvent {
    ...
    private String eventCategory; // ALLOCATION, COMMUNICATION, COLLECTION, WORKFLOW, SYSTEM
    ...
    private String actorType; // USER, SYSTEM, STRATEGY, AGENCY
    ...
    private String communicationChannel; // SMS, EMAIL, WHATSAPP, CALL
