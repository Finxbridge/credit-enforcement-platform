...
-- ===================================================
-- PAYMENT GATEWAY DOMAIN INDEXES
-- ===================================================
...
-- ===================================================
-- ALLOCATION & REALLOCATION DOMAIN INDEXES
-- ===================================================
...
-- ===================================================
-- STRATEGY ENGINE DOMAIN INDEXES
-- ===================================================
...
CREATE INDEX IF NOT EXISTS idx_strategies_active_lookup ON strategies(is_active, status, priority DESC) WHERE is_active = TRUE;
...
CREATE INDEX IF NOT EXISTS idx_executions_strategy_lookup ON strategy_executions(strategy_id, started_at DESC);
