 ...
 * Updated to match unified CSV format with 80+ columns
 */
@Entity
...
public class LoanDetails {
    ...
    private BigDecimal pos; // POS

    @Column(name = "tos", precision = 15, scale = 2)
    private BigDecimal tos; // TOS
    ...
    private String loanDuration; // LOAN DURATION
